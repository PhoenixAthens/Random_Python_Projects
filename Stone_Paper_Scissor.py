...
while True:
    ...
    if value=="y" or value=="Y":
        ...
        if givenAnswer in list:
        
            providedAnswer=random.choice(list)

            if givenAnswer==providedAnswer:
                print("It's a tie")
                print("let's go again, i bet you can't defeat me\n")
                text="you in then ? (y/n) \n"
            elif (givenAnswer=="Paper" and providedAnswer=="Rock") or (givenAnswer=="Rock" and providedAnswer=="Scissor") or (givenAnswer=="Scissor" and providedAnswer=="Paper"):
                print(" You won! ")
